...
class AccountMapperTest {
  ...
  /**
   * Method under test: {@link AccountMapper#mapAccountRoleSourceToName(AccountRole)}
   */
  @Test
  void testMapAccountRoleSourceToName() {
    // Arrange
    ...
    // Act and Assert
    assertEquals("Role Name", accountMapper.mapAccountRoleSourceToName(accountRole));
  }
   ...
   */
  @Test
  void testMapAccountRoleSourceToName2() {
    // Arrange
    ...
    // Act
    String actualMapAccountRoleSourceToNameResult = accountMapper.mapAccountRoleSourceToName(accountRole);
    ...
    assertEquals("Role Name", actualMapAccountRoleSourceToNameResult);
  }

  /**
  * Method under test: {@link AccountMapper#afterMapping(AccountDTO, Account)}
  */
  @Test
  void testAfterMapping() {
    ...
    sessionAccount.setAccountId(1);
    sessionAccount.setAccountRoles(new HashSet<>());
    sessionAccount.setConversations(new HashSet<>());
    sessionAccount.setCreatedAt(LocalDate.of(1970, 1, 1).atStartOfDay());
    sessionAccount.setCreatedBy("Jan 1, 2020 8:00am GMT+0100");
    sessionAccount.setEmail("jane.doe@example.org");
    sessionAccount.setEnabled(true);
    sessionAccount.setMobileNumber("42");
    sessionAccount.setPassword("iloveyou");
    sessionAccount.setUpdatedAt(LocalDate.of(1970, 1, 1).atStartOfDay());
    sessionAccount.setUpdatedBy("2020-03-01");
    sessionAccount.setUserName("janedoe");

    // Act
    accountMapper.afterMapping(AccountDTO, sessionAccount);
    ...
    assertEquals("Company Name", AccountDTO.getImageUrl());
    assertEquals("Name", AccountDTO.getUserName());
  }
}
