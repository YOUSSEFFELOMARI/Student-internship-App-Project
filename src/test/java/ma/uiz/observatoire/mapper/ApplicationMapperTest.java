...
class ApplicationMapperTest {
  ...
  /**
   * Method under test: {@link ApplicationMapper#getStudentFromApp(Application)}
   */
  @Test
  void testGetStudentFromApp() {
    // Arrange
    ...
    app.setApplicationDate(Date.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant()));
    ...
    // Act
    StudentDTO actualStudentFromApp = applicationMapper.getStudentFromApp(app);

    // Assert
    verify(studentMapper).mapToDto(Mockito.<Student>any());
    assertSame(studentDTO, actualStudentFromApp);
  }

  /**
  * Method under test: {@link ApplicationMapper#getOfferFromApp(Application)}
  */
  @Test
  void testGetOfferFromApp() {
    // Arrange
    ...
    // Act
    OfferDTO actualOfferFromApp = applicationMapper.getOfferFromApp(app);

    // Assert
    verify(offerMapper).mapToDto(Mockito.<Offer>any());
    assertSame(offerDTO, actualOfferFromApp);
  }
}
